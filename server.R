...
server <- function(input, output) {
  ...
  output$popn_plot <- renderPlot({
    ...
    vancouver %>% 
      ...
      labs(x = "Origem", y = "População", title = "") +
      coord_flip() +
      theme_bw() +
